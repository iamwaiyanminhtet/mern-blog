import { Badge, TextInput, Button, Select, Spinner } from "flowbite-react"
...
const Search = () => {
    ...
    return (
        <>
            <div className="bg-inherit max-w-4xl mx-auto min-h-[calc(85dvh-80px)]">
                {
                    loading &&
                    <div className="flex justify-center min-h-[calc(90dvh-90px)] max-w-fit items-center min-w-full text-center">
