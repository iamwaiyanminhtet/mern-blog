        ...
        <>
            {
                ...
                <article key={curReply._id} className={`p-6 mb-3 ml-6 mt-2 lg:ml-12 text-base bg-white rounded-lg dark:bg-black `} >
                    <footer className="flex justify-between flex-col sm:flex-row items-start sm:items-center mb-2">
                        <div className="flex items-start md:items-center flex-col sm:flex-row gap-1 ">
